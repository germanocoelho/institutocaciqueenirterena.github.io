...
PALAVRAS = {
    ...
    3: ["artesanato", "cerâmica", "ceramica", "patrimônio cultural",
        ...
        "salvaguarda", "gestão territorial", "gestao territorial", "pngati",
        "pgta", "aldeia", "marca coletiva", "indicação geográfica",
        "indicacao geografica", "educação bilíngue", "educacao bilingue"],
    2: ["cultura", "cultural", "mulheres", "direitos humanos", "juventude",
        "artes cênicas", "artes visuais", "música", "musica", "dança", "danca",
        ...
        "apicultura", "agricultura familiar", "turismo de base",
        "esporte", "empreendedorismo", "geração de renda", "geracao de renda",
        "economia solidária", "economia solidaria", "saúde indígena",
        "saude indigena", "saneamento", "habitação", "habitacao",
        "ponto de cultura", "mestres", "artesãs", "artesas", "ceramistas"],
